...
func main() {
	...
	permissions := []model.Permission{
		...
		{ID: 10, Name: permissions.PostPhotoUpdateAny},
		{ID: 11, Name: permissions.PostPhotoUpdateOwn},
		{ID: 12, Name: permissions.PostVerify},
		{ID: 13, Name: permissions.PostMarkReturnedAny},
		{ID: 14, Name: permissions.PostMarkReturnedOwn},
		{ID: 15, Name: permissions.ConversationCreate},
		{ID: 16, Name: permissions.ConversationReadOwn},
		{ID: 17, Name: permissions.ConversationMessageSend},
		{ID: 18, Name: permissions.ConversationMessageMarkAsRead},
		{ID: 19, Name: permissions.UserReadOwn},
		{ID: 20, Name: permissions.UserReadOther},
		{ID: 21, Name: permissions.UserReadAll},
		{ID: 22, Name: permissions.UserUpdateOwn},
		{ID: 23, Name: permissions.UserDeleteAnyAdmin},
		{ID: 24, Name: permissions.UserDeleteAnyUser},
		{ID: 25, Name: permissions.UserDeleteOwn},
		...
		{ID: 30, Name: permissions.SubjectUpdate},
		{ID: 31, Name: permissions.SubjectDelete},
		{ID: 32, Name: permissions.StudentGroupCreate},
		{ID: 33, Name: permissions.StudentGroupUpdate},
		{ID: 34, Name: permissions.StudentGroupDelete},
		{ID: 35, Name: permissions.StudentGroupAdvisorAssign},
		{ID: 36, Name: permissions.StudentGroupAdvisorUnassignAny},
		{ID: 37, Name: permissions.StudentGroupAdvisorUnassignOwn},
		{ID: 38, Name: permissions.StudentGroupAdvisorRead},
		{ID: 39, Name: permissions.TeacherSubjectReadAny},
		{ID: 40, Name: permissions.TeacherSubjectReadOwn},
		{ID: 41, Name: permissions.TeacherSubjectAddAny},
		{ID: 42, Name: permissions.TeacherSubjectAddOwn},
		...
		{ID: 55, Name: permissions.TeacherStudentGroupReadOwn},
		{ID: 56, Name: permissions.ParentStudentReadAny},
		{ID: 57, Name: permissions.ParentStudentReadOwn},
		{ID: 58, Name: permissions.ParentStudentAddAny},
		{ID: 59, Name: permissions.ParentStudentAddOwn},
		{ID: 60, Name: permissions.ParentStudentUnassignAny},
		{ID: 61, Name: permissions.ParentStudentUnassignOwn},
		{ID: 62, Name: permissions.ParentReadOther},
		{ID: 63, Name: permissions.ParentReadOwn},
		{ID: 64, Name: permissions.ParentStudentGroupReadOwn},
		{ID: 65, Name: permissions.RoleAdminAssign},
		{ID: 66, Name: permissions.RoleUserAssign},
		{ID: 67, Name: permissions.RoleAdminAdd},
		{ID: 68, Name: permissions.RoleUserAdd},
		{ID: 69, Name: permissions.RoleAdminUnassign},
		{ID: 70, Name: permissions.RoleUserUnassign},
		{ID: 71, Name: permissions.RoleReadAny},
		{ID: 72, Name: permissions.RoleReadOwn},
		{ID: 73, Name: permissions.TokenInviteAdminCreate},
		{ID: 74, Name: permissions.TokenInviteUserCreate},
		{ID: 75, Name: permissions.TokenInviteAdminDelete},
		{ID: 76, Name: permissions.TokenInviteUserDelete},
		{ID: 77, Name: permissions.StudentReadOther},
		{ID: 78, Name: permissions.StudentReadOwn},
		{ID: 79, Name: permissions.StudentClassroomReadAny},
		{ID: 80, Name: permissions.StudentClassroomReadOwn},
		{ID: 81, Name: permissions.StudentAdvisorReadAny},
		{ID: 82, Name: permissions.StudentAdvisorReadOwn},
		{ID: 83, Name: permissions.StudentParentReadAny},
		{ID: 84, Name: permissions.StudentParentReadOwn},
		{ID: 85, Name: permissions.StudentStudentGroupReadOwn},
		{ID: 86, Name: permissions.InstitutionAdministratorReadOther},
		{ID: 87, Name: permissions.InstitutionAdministratorReadOwn},
		{ID: 88, Name: permissions.InstitutionAdministratorPositionAssign},
		{ID: 89, Name: permissions.InstitutionAdministratorPositionRead},
		{ID: 90, Name: permissions.StaffReadOther},
		{ID: 91, Name: permissions.StaffReadOwn},
		{ID: 92, Name: permissions.StaffPositionAssign},
		{ID: 93, Name: permissions.StaffPositionRead},
		{ID: 94, Name: permissions.PositionInstitutionAdministratorCreate},
		{ID: 95, Name: permissions.PositionInstitutionAdministratorUpdate},
		{ID: 96, Name: permissions.PositionInstitutionAdministratorDelete},
		{ID: 97, Name: permissions.PositionStaffCreate},
		{ID: 98, Name: permissions.PositionStaffUpdate},
		{ID: 99, Name: permissions.PositionStaffDelete},
		{ID: 100, Name: permissions.DocumentPrivacyUpload},
	}
