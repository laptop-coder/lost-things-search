      ...
      <div class="w-full max-w-md">
        ...
        >
          {!role() ? (
            <div class="bg-white rounded-2xl shadow-lg p-6 flex flex-col gap-4">
              <div class="flex flex-row gap-4">
                <button
                  type="button"
                  disabled={loading()}
                  class="px-2 sm:px-4 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition font-medium disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer w-full h-full"
            ...
            <div class="bg-green-100 border border-green-400 text-green-800 px-4 py-3 rounded-xl flex flex-col md:flex-row items-center gap-3">
              <Mail />
              <span>
