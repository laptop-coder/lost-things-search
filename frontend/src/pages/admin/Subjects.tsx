...
const Subjects = () => {
  ...
  return (
    <div class="space-y-6 p-4">
      <div class="mb-6">
        <h1 class="text-3xl font-bold text-text">Управление предметами</h1>
        <p class="text-text-muted mt-1">Список учебных дисциплин</p>
      </div>
      ...
      <Show when={!loading() && subjects().length === 0}>
        <div class="flex flex-col items-center justify-center gap-1 py-16">
          <BookOpen class="w-15 h-15 mb-3 text-text" />
          <p class="text-text">Нет предметов</p>
          <p class="text-text-muted text-sm mt-1">Создайте первый</p>
        </div>
      </Show>
